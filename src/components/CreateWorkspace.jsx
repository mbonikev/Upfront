...
function CreateWorkspace() {
  return (
    <div className="w-[300px] flex flex-col gap-2">
      ...
      <form className="flex-1 flex flex-col gap-0 pb-2">
        <div className="flex flex-col gap-2 px-2 pt-2">
          <h1 className="font-normal text-sm">Workspace Name</h1>
          <input
            type="text"
            className="w-full h-[30px] rounded-lg px-3 ring-1 ring-stone-200 focus:ring-2 focus:ring-main-color/60 transition bg-stone-100 dark:bg-[#404040] dark:ring-[#474747]"
          />
        </div>
