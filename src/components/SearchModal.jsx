...
function SearchModal({ Hide }) {
  ...
  return (
    <div className="w-[810px] h-full pl-5 pr-1 py-[15px] flex flex-col">
      <div className="flex items-center justify-start gap-3 h-[35px] px-1 text-[#a1a1a1] bg-[#2f2f2f]">
        <div>
      ...
      <div className="w-full flex-1 mt-0 flex items-start justify-start gap-5">
