    ...
    <div className="w-[750px] h-full py-3 flex flex-col">
      ...
      <div className="w-full flex-1 flex items-start justify-start gap-5 px-3">
        <div className="w-1/3 h-full flex items-start justify-start flex-col gap-2">
          <button className="outline-none flex items-center justify-start bg-[#505050] dark:bg-[#2f2f2f] w-full h-8 px-3 rounded-xl gap-2 text-[#a1a1a1] text-sm font-medium ">
            <LuHash className="text-lg" />
            <span className="text-[#f0f0f0] tracking-tight">Projects</span>
          </button>
          <button className="outline-none flex items-center justify-start hover:bg-[#505050] dark:hover:bg-[#2f2f2f] w-full h-8 px-3 rounded-xl gap-2 text-[#a1a1a1] text-sm font-medium ">
