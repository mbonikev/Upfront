  ...
  return (
    <div className="w-full flex flex-col justify-start items-start bg-white dark:bg-[#2c2c2c]">
      <div className="p-2 w-full">
        <div className="w-full min-h-[34px] flex items-center justify-start gap-2 px-2 py-[3px] text-sm font-normal tracking-tight rounded-md hover:bg-stone-200/50 dark:hover:bg-[#383838] line-clamp-1 ">
          ...
          <div className="w-full h-fit flex flex-col justify-center items-start">
            <p className="line-clamp-1 text-sm font-medium text-text-color dark:text-[#b8b8b8]">
              {username}
            </p>
