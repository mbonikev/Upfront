    ...
    return (
        <div className='w-full flex flex-col justify-start items-start bg-white dark:bg-[#2c2c2c]'>
            <div className='p-2 w-full'>
                <button to={'/'} className='w-full min-h-[34px] flex items-center justify-start gap-2 px-2 py-[3px] text-sm font-normal tracking-tight rounded-md hover:bg-stone-200/50 dark:hover:bg-[#383838] line-clamp-1 '>
                    ...
                    <div className='w-full h-fit flex flex-col justify-center items-start'>
                        <p className='line-clamp-1 text-sm font-medium text-text-color dark:text-[#b8b8b8]'>{username}</p>
                        <p className='line-clamp-1 text-text-color/70 text-xs dark:text-[#b8b8b8]/70'>242 Completed </p>
                    </div>
                </button>
            </div>
            ...
            <div className='w-full h-[1px] bg-border-line-color/70 dark:bg-[#383838]'></div>
            <div className='p-2 flex flex-col w-full'>
                <button onClick={handleLogout} className={`min-h-[34px] flex items-center gap-2 px-2 py-[7px] font-normal text-text-color dark:text-[#b8b8b8] text-sm tracking-tight rounded-md hover:bg-stone-200/50 dark:hover:bg-[#383838] line-clamp-1 ${logoutAnimate ? 'pointer-events-none' : ''}`}>
                    {logoutAnimate ? <>
