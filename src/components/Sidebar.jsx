...
function Sidebar({ handleSidebarToggle, username, userEmail, w1, setW1 }) {
  ...
  const linkStyle =
    "min-h-[34px] w-full flex items-center gap-2 px-2 py-[7px] font-normal dark:text-[#b8b8b8] dark:hover:bg-[#2c2c2c] text-text-color/90 tracking-tight rounded-lg line-clamp-1 relative select-none active:bg-stone-100 dark:active:brightness-125";
            ...
            <form onSubmit={handleSubmit1} className="relative group mb-10 ">
              ...
              {moreOpt1 && (
                <div
                  ...
                  className={`fixed bg-white dark:bg-[#2c2c2c] dark:shadow-custom2 rounded-xl h-fit shadow-md z-[1000] ring-1 ring-border-line-color/50 dark:ring-stone-600/30 p-1 transition-all ease-in-out duration-1000 overflow-clip ${
                    moreOpt1 ? "w-fit min-w-[160px]" : "opacity-0 w-0"
                  }`}
                >
                  <Reveal
