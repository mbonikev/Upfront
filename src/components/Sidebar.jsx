...
function Sidebar({ handleSidebarToggle, mleft, username, userEmail, w1, setW1, w2, setW2, w3, setW3 }) {
    ...
    return (
        <div className={` z-30 ${mleft ? ' w-[256px] ' :' w-0 overflow-hidden transition-all duration-300 ease-in-out '}`}>
