      ...
      <div className=" relative w-full h-full ">
        ...
        {showSearchModal && (
          <div
            ...
            className={` top-0 left-0 w-full h-full z-20 dark:bg-black/40 backdrop-blur-[2px] fixed transition-all duration-300 ${
        ...
        {showSearchModal && (
          <div
            className={`w-fit h-full max-h-[63%] 2xl:max-h-[500px] bg-[#202020ea] dark:bg-[#252525ea] backdrop-blur-2xl rounded-[25px] fixed top-0 left-0 right-0 bottom-0 m-auto shadow-custom ring-1 ring-border-line-color/0 z-30 transition-all duration-150 
              ${
