      ...
      <div className=" relative w-full h-full">
        ...
        <div className="w-full h-fit min-h-svh max-h-svh border-r-[1px] border-border-line-color/20 dark:border-[#313131a6] bg-sidebar-color dark:bg-[#202020] dark:text-[#b8b8b8] flex flex-col gap-[2px] p-3 text-sm overflow-y-auto">
          ...
          <Link
            ...
            className={`${linkStyle} hover:bg-stone-200/50 group-hover:bg-stone-200/50`}
          >
            <div className="text-text-color/50 dark:text-[#858585] text-xl bg-red-200/0 w-[20px] min-w-[20px] h-[20px] relative px-[2px] flex flex-col items-center justify-center gap-[3px]">
              <div className="w-full h-[2px] min-h-[2px] rounded-[5px] bg-text-color/50 dark:bg-[#858585] z-10 relative">
                <div className="h-[4px] w-[2px] rounded-[5px] bg-text-color/50 dark:bg-[#959595] absolute top-[-2px] left-[2px]"></div>
                <div className="h-[4px] w-[2px] rounded-[5px] bg-text-color/50 dark:bg-[#959595] absolute top-[-2px] right-[2px]"></div>
              </div>
              <div className="w-fit h-fit flex-1 text-text-color/50 dark:text-[#858585] text-[14px] font-semibold leading-none z-10 tracking-wide">
                16
              </div>
            </div>
