                ...
                <div className="w-full h-fit min-h-svh max-h-svh border-r-[1px] border-border-line-color/20 dark:border-[#313131a6] bg-sidebar-color dark:bg-[#202020] dark:text-[#b8b8b8] flex flex-col gap-[2px] p-3 text-sm overflow-y-auto">
                    ...
                    >
                        <div className="text-text-color/50 dark:text-[#858585] text-xl w-[20px] min-w-[20px] h-[20px] relative" >
                            <div className="border-[2px] h-full w-full border-text-color/50 dark:border-[#858585] rounded-[5px] bg-yellow-400 p-[2px]">
                                <div className="w-full h-[3px] min-h-[3px] rounded-[5px] bg-text-color/50 dark:bg-red-500 z-10"></div>
                                <div className="w-full flex-1 text-text-color/50 dark:text-red-500 text-[11px] leading-0 z-10">15</div>
                            </div>
                        </div>
