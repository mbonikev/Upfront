        ...
        <div className="w-full h-full border-r-[2px] border-stone-200/70 dark:border-[#313131a6] bg-white dark:bg-[#202020] dark:text-[#b8b8b8] flex flex-col gap-[2px] p-2 text-sm min-h-svh max-h-svh overflow-y-auto overscroll-contain">
          ...
          <div className="flex-1 flex flex-col gap-[3px]">
            ...
            <p className="group flex items-center justify-start gap-2 mt-[6px] rounded-lg pt-[7px] pr-0 pl-[8px] font-medium dark:text-[#b8b8b8]/70 text-text-color/70 tracking-tight select-none  w-full">
              ...
              <button className="flex items-center justify-center text-base cursor-pointer hover:bg-stone-100 dark:hover:text-[#303030] dark:active:brightness-125 rounded-md h-[22px] w-auto aspect-square opacity-0 group-hover:opacity-100 transition duration-75">
                <LuPlus />
              </button>
            </p>
            {/* Workspace */}
