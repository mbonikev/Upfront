  ...
  return (
    <div className="w-[256px] min-w-[256px] max-h-svh sticky top-0 z-20">
      <div className=" relative w-full h-full ">
        ...
        {showSearchModal && (
          <div
            className={`w-fit h-full max-h-[63%] 2xl:max-h-[500px] bg-[#202020] dark:bg-[#252525] rounded-3xl fixed top-0 left-0 right-0 bottom-0 m-auto shadow-custom ring-1 ring-border-line-color/0 z-30 transition-all duration-150 
              ${
