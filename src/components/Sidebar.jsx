        ...
        <div className="w-full h-fit min-h-svh max-h-svh border-r-[1px] border-border-line-color/20 dark:border-[#313131a6] bg-sidebar-color dark:bg-[#202020] dark:text-[#b8b8b8] flex flex-col gap-[2px] p-2 text-sm overflow-y-auto overscroll-contain">
          ...
          <div className="flex-1 flex flex-col gap-[3px]">
            ...
            <form onSubmit={handleSubmit1} className="relative group mb-10 ">
              ...
              {saveOpt1 && (
                <>
                  <div className="w-[100%] h-[100%] absolute top-0 left-0 z-30 text-text-color/50 dark:text-[#858585] bg-white dark:bg-[#202020] flex items-center justify-center gap-3 py-1 pl-[8px]">
                    {authing ? (
                      <>
