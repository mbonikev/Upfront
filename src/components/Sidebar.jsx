...
function Sidebar({
    ...
    const handleCreate = async () => {
        setCreateNew(true);
        const dummyEmoji = 2
        const dummyTitle = 'Hello sirer[goergm[eomg'
        const dummyDescription = 'jejeferfprfke[r] Scissors are hand-operated shearing tools. A pair of scissors consists of a pair of blades pivoted so that the sharpened edges slide against each other.'
        try {
