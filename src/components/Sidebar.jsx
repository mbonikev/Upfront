  ...
  return (
    <div className="w-[256px] min-w-[256px] sticky top-0 z-20 ">
      <div className=" relative w-full h-full">
        ...
        ></div>
        {/* search modal */}
        <div className="w-fit h-fit bg-[#242424]/80 backdrop-blur-[30px] rounded-[25px] fixed top-0 left-0 right-0 bottom-0 m-auto shadow-custom ring-1 ring-border-line-color/0 z-30">
          <SearchModal />
        </div>
        {/* dropdown */}
        {profileMenu && (
