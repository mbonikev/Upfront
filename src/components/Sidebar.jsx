  ...
  return (
    <div className="w-[256px] min-w-[256px] max-h-svh sticky top-0 z-20">
      <div className=" relative w-full h-full ">
        ...
        <div className="w-full h-full border-r-[2px] border-stone-200 dark:border-[#313131a6] bg-white dark:bg-[#202020] dark:text-[#b8b8b8] flex flex-col gap-[2px] p-2 text-sm min-h-svh max-h-svh overflow-y-auto overscroll-contain">
          {/* 1 */}
          ...
          {/* 2 */}
          <div className="flex-1 flex flex-col gap-[3px] pb-4">
            <Link
              to={"/"}
          ...
          {/* 3 */}
          <div className="w-full h-fit flex flex-col items-center justify-between gap-[3px] sticky bottom-0 bg">
            <button
