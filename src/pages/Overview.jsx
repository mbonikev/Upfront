          ...
          <>
            ...
            <div className="group relative w-full min-h-[50px] max-w-[900px] mt-2 mx-auto px-7 max-xl:px-0 flex items-start justify-start flex-col overflow-x-auto hidden_scrollbar">
              ...
              <div
                ...
                className={`w-full flex-1 h-fit flex items-center justify-start overflow-auto hidden_scrollbar overscroll-contain gap-3 pt-2 pb-10 px-3 transition`}
              >
                {myProjects.map((project, index) => (
                  ...
                  >
                    ...
                    <h1 className="text-text-color/75 dark:text-[#dfdfdf] font-normal w-full min-h-fit h-fit px-3 pt-[29px] whitespace-nowrap truncate text-sm">
                      {project.name !== "" ? project.name : "Untitled"}
                    </h1>
                    <div className="flex-1 pb-2 px-3 w-full flex items-end justify-start  gap-1">
                      <h1 className="text-dark-body/50 dark:text-light-text-color/80 dark:bg-[#303030] font-normal w-full text-xs flex items-center justify-between gap-1.5">
                        <span className="text-xs opacity-85">
                          <TimeAgo date={project.createdAt} />
                        </span>
                        <span title={`${project.collaborations.length} has access`} className="h-[24px] w-[24px] min-w-[24px] aspect-square flex items-center justify-center rounded-full bg-main-color text-white dark:bg-[#424242] dark:text-light-text-color capitalize font-semibold">
