...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
      ...
      >
        <div className="relative w-full flex-1 bg-stone-100 min-h-[50px] max-w-full mx-auto px-7 max-xl:px-0 flex items-start justify-start overflow-x-auto">
          {/* Left Button */}
          {canScrollLeft && (
            <div className="nextSpace w-[80px] h-full absolute top-0 left-5 max-xl:left-0 bg-gradient-to-r max-xl:pl-2 from-stone-100 via-stone-100 to-transparent z-20 flex items-center justify-start">
              <button
                onClick={scrollLeft}
