...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative">
      ...
      />
      <div
        className={`w-full h-full min-h-svh flex-1 text-text-color bg-stone-50 dark:bg-dark-body transition-all duration-500 ease-in-out z-10 flex items-start justify-start`}
      >
        <div className="relative w-auto flex-1 h-full max-w-[2300px] mx-auto px-7 max-xl:px-0">
          ...
          <div
            ...
            className={` w-full max-w-full h-fit flex overflow-auto gap-5 pt-4 pb-1 hidden_scrollbar `}
          >
