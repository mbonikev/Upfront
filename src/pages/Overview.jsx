                ...
                {myProjects.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="w-full h-[45px] bg-stone-200 dark:bg-[#282828] relative">
                      <div className="h-[40px] w-[40px] min-w-[40px] rounded-full bg-stone-200 dark:bg-[#303030] text-text-color dark:text-[#979797] aspect-square translate-y-6 translate-x-3 ring-2 ring-white dark:ring-[#202020] dark:ring flex items-center justify-center text-xl">
                        <LuHash />
                      </div>
                    </div>
                    <h1 className="text-dark-body/50 dark:text-[#b8b8b8]/80 font-normal w-full min-h-fit h-fit px-3 pt-[29px] whitespace-nowrap truncate text-sm">
                    ...
                    <div className="flex-1 pb-2 px-3 w-full flex items-end justify-start gap-1">
                      {project.collaborations.map((collab, index) => (
                        <h1 key={index} className="text-dark-body/50 dark:text-[#b8b8b8]/80 font-normal w-full text-xs flex items-center justify-start gap-1.5">
                          <span className="h-[20px] w-[20px] min-w-[20px] aspect-square flex items-center justify-center rounded-full bg-main-color text-white dark:bg-[#424242] dark:text-[#b8b8b8] capitalize font-semibold">{collab.charAt(0)}</span>
