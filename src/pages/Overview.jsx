...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative">
      ...
      >
        <div className="relative w-full flex-1 bg-red-200 min-h-[50px] max-w-[2300px] mx-auto px-7 max-xl:px-0 flex items-start justify-start">
          {/* Left Button */}
          {canScrollLeft && (
          ...
          <div
            ...
            className={` w-full flex-1 h-fit bg-red-200 flex overflow-x-auto gap-5 pt-4 pb-1 hidden_scrollbar `}
          >
