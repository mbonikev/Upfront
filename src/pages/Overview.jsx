              ...
              >
                {myProjects.map((project, index) => (
                  <Link
                    ...
                    key={index}
                    className="w-[150px] min-w-[150px] h-[150px] flex items-start justify-start flex-col rounded-xl bg-white dark:bg-[#202020] text-dark-body dark:text-[#b8b8b8] ring-1 ring-stone-200/70 dark:ring-dark-body transition active:scale-95 overflow-hidden hover:ring-2 hover:ring-main-color/50"
                  >
                    {/* banner */}
                    ...
                    <h1 className="text-dark-body/50 dark:text-[#b8b8b8]/80 font-normal w-full min-h-fit h-fit bg-red-200 px-3 pt-[29px] line-clamp-2 text-sm">
                      {project.name}
                    </h1>
                    <div className="flex-1 bg-red-700 pb-1 px-3 w-full flex items-end justify-start gap-1">
                      {project.collaborations.map((collab, index) => (
                        <h1 key={index} className="text-dark-body/50 dark:text-[#b8b8b8]/80 font-normal w-full text-sm">
                          <span className="h-[23px] w-[23px] min-w-[23px] aspect-square flex items-center justify-center rounded-full dark:bg-[#424242] text-[#b8b8b8] capitalize font-semibold">{collab.charAt(0)}</span>
                        </h1>
                      ))}
                    </div>
                  </Link>
