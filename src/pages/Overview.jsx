...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
      ...
      >
        <div className="relative w-full flex-1 bg-red-200 min-h-[50px] max-w-[800px] mx-auto px-7 max-xl:px-0 flex items-start justify-start overflow-x-auto">
          {/* Left Button */}
          {canScrollLeft && (
          ...
          <div
            ...
            className={`w-full max-w-screen-md flex-1 h-fit bg-red-200 flex items-center justify-start overflow-auto gap-5 `}
          >
