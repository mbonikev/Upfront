...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
      ...
      >
        <div className="relative w-full flex-1 bg-stone-50 min-h-[50px] max-w-[900px] mt-5 mx-auto px-7 max-xl:px-0 flex items-start justify-start flex-col overflow-x-auto">
          {/* Left Button */}
          {canScrollLeft && (
