...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
      ...
      /> */}
      <div
        className={`w-auto h-full min-h-svh flex-1 text-text-color bg-stone-50 dark:bg-dark-body transition-all duration-500 ease-in-out z-10 overflow-clip flex items-start justify-start p-1`}
      >
        <div className="relative w-full flex-1 bg-green-200 min-h-[50px] max-w-[800px] mx-auto px-7 max-xl:px-0 flex items-start justify-start overflow-x-auto">
          {/* Left Button */}
          {canScrollLeft && (
          ...
          <div
            ...
            className={`w-full max-w-[400px] flex-1 h-fit bg-red-200 flex items-center justify-start overflow-auto gap-5 `}
          >
            {[...Array(29)].map((space, index) => (
