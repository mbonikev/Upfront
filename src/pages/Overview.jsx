  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
      ...
      >
        ...
        <h1 className="text-dark-body dark:text-[#b8b8b8] font-light bg-red-300 w-full max-w-[900px] mx-auto px-7 mt-10 text-sm">
          Recently visited
        </h1>
        <div className="relative w-full bg-stone-50 dark:bg-dark-body min-h-[50px] max-w-[900px] mt-5 mx-auto px-7 max-xl:px-0 flex items-start justify-start flex-col overflow-x-auto">
          ...
          {canScrollLeft && (
            <div className="nextSpace w-[80px] h-full absolute top-0 left-5 max-xl:left-0 bg-gradient-to-r max-xl:pl-2 from-stone-50 dark:from-dark-body via-stone-50 dark:via-dark-body to-transparent z-20 flex items-center justify-start">
              <button
                onClick={scrollLeft}
                className="h-[30px] w-auto aspect-square ring-1 ring-stone-200 hover:ring-stone-400  dark:bg-[#2c2c2c] dark:text-[#727272] dark:hover:text-[#b8b8b8] dark:ring-transparent dark:hover:ring-transparent flex items-center justify-center rounded-full"
              >
          ...
          <div
            ...
            className={`w-full flex-1 h-fit bg-stone-50 dark:bg-dark-body flex items-center justify-start overflow-auto gap-5 py-2`}
          >
