...
function SingleProject() {
  ...
  return (
    <>
      ...
      <button className="group overflow-clip w-[40px] h-[40px] hover:w-[150px] fixed z-10 bottom-5 right-5 flex items-center justify-center gap-1 text-sm font-semibold px-4 py-2 rounded-full transition-all duration-200 bg-white dark:bg-[#242424] text-dark-body dark:text-white ring-1 ring-stone-200 dark:ring-stone-300/10 dark:active:bg-[#313131] active:scale-[.99] shadow-lg">
