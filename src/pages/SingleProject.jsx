...
function SingleProject() {
  ...
  return (
    <>
      ...
      {showAi && (
        <div
          className={`w-[350px] h-[400px] max-h-[400px] p-2 fixed bottom-4 right-4 rounded-xl shadow-xl ring-1 ring-border-line-color/0 overflow-y-auto z-50 bg-white dark:bg-[#242424] transition-all duration-200
