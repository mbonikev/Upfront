...
function SingleProject() {
  ...
  return (
    <>
      ...
      {showAi && (
        <div
          className={`w-[350px] h-[400px] max-h-[400px] p-2 fixed bottom-4 right-4 rounded-xl shadow-custom ring-1 ring-border-line-color overflow-y-auto z-50 bg-white dark:bg-[#242424] transition-all duration-300
