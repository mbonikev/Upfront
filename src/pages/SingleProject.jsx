          ...
          <div className="w-full h-fit flex items-start justify-start mb-1 gap-3">
            ...
            <div className="flex-1 flex flex-col items-start max-w-[1200px] justify-start gap-2 w-full h-fit">
              <textarea
                ...
                className="text-3xl font-extrabold w-full bg-red-300 placeholder:text-text-color/70 resize-none bg-white dark:bg-dark-body dark:placeholder:text-[#b8b8b8]/70 dark:text-[#d4d4d4]"
              />
              <textarea
                type="text"
                id="ProjectDesc"
