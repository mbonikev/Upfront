...
function SingleProject() {
  ...
  return (
    <>
      ...
      <div
        className={`w-full h-svh text-text-color flex flex-col bg-white overflow-hidden relative `}
      >
        ...
        {/* Project section */}
        {/* <div className="w-fit h-full flex-1  bg-red-500  pt-0 pb-3 "> */}
        {/* loader on fetch */}
        ...
        >
          ...
          {boards.length > 0 && (
            boards.map((board, index) => (
              <div className="min-h-[300px] w-[230px] min-w-[230px] bg-stone-200/50 select-none flex flex-col p-3 rounded-xl text-text-color">
