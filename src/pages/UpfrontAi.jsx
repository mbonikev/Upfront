...
function UpfrontAi() {
    ...
    return (
        <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
            ...
            />
            <div
                className={`w-[calc(100%-256px)] h-full min-h-svh flex-1 text-text-color dark:text-[#b8b8b8] bg-white dark:bg-dark-body transition-all duration-500 ease-in-out z-10 overflow-clip flex items-start justify-start flex-col p-1`}
            >
                {/* title */}
                <h1 className="font-Custom_2xb">Upfront Ai</h1>
            </div>
        </div>
    );
}
