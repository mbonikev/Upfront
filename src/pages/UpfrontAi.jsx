...
function UpfrontAi() {
    ...
    return (
        <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative overflow-x-hidden">
            ...
            />
            <div
                className={`w-[calc(100%-256px)] h-full min-h-svh flex-1 text-text-color dark:text-[#e2e2e2] text-5xl bg-white dark:bg-dark-body transition-all duration-500 ease-in-out z-10 overflow-clip flex items-center justify-start flex-col px-5 py-20`}
            >
                {/* title */}
