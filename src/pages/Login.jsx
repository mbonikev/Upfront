    ...
    <div className='w-full h-fit min-h-svh flex flex-col text-sm text-text-color'>
      ...
      <div className="w-full max-w-[400px] p-5 mx-auto h-full flex-1 flex flex-col items-start justify-center gap-2">
        <div className='w-full'>
          ...
          <p className='font-medium opacity-70 pb-4 text-xs'>Hi, Welcome back!</p>
        ...
        <h1 className='relative w-full py-3'>
          <hr className='border-border-line-color z-10' />
          <span className='absolute top-0 left-0 bottom-0 right-0 m-auto w-fit h-fit bg-white text-xs px-3 font-medium opacity-70 '>or login with Email</span>
        </h1>
