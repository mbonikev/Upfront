          ...
          {fetchingProjects ? (
            ...
            <>
              <div className="flex items-center justify-start gap-2 ">
                <FcFolder className="text-3xl text-text-color/50 dark:text-[#858585]" />
                <h1 className="text-2xl translate-y-[1px] font-extrabold tracking-normal max-w-[500px] break-words dark:text-[#d4d4d4]">
                  {pageTitle}
            ...
            <>
              <div className="grid grid-cols-4 2xl:grid-cols-5 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-3 pt-4 relative">
                {[...Array(3)].map((_, index) => (
                  <div
                    key={index}
                    className="group z-10 relative w-full h-fit rounded-2xl animate-smooth-pulse bg-stone-100 dark:bg-[#232323] flex flex-col gap-3 p-4"
                  >
                    {/* icon */}
                    <div className="group z-10 relative w-8 h-8 min-w-8 aspect-square rounded-2xl dark:bg-[#313131] bg-stone-200 ring-4 ring-stone-100 dark:ring-[#232323]"></div>
                    {/* title */}
                    <div className="group z-10 relative w-1/5 h-[10px] rounded-2xl dark:bg-[#313131] bg-stone-200"></div>
                    {/* desc */}
                ...
                <div className="grid grid-cols-4 2xl:grid-cols-5 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-3 pt-4 relative">
                  ...
                  >
                    {createNew ? (
                      ...
                      <div className="flex items-center justify-center flex-col gap-1">
                        <IoIosAddCircle className="text-3xl text-text-color/70 dark:text-[#484848]" />
                  ...
                  {myProjects.map((project, index) => (
                    ...
                    >
                      ...
                      >
                        <div className="h-[40px] text-xl w-[40px] bg-stone-100 dark:bg-[#303030] text-[#979797] min-h-fit min-w-fit aspect-square rounded-full mb-2 flex items-center justify-center">
                          <LuHash />
                        </div>
                        ...
                        <div className="flex items-end flex-col gap-1 pt-2">
                          <div
