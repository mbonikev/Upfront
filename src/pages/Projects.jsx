                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 py-3">
                          ...
                          >
                            <div
                              className={`flex flex-col justify-center rounded-full overflow-hidden text-xs text-white text-center whitespace-nowrap transition duration-500 ${getProgressClasses(33)} ${'w-[40px]'}`}
                            ></div>
                          </div>
