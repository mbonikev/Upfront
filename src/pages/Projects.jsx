...
function Projects() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-[#b8b8b8] flex items-start justify-start relative">
      ...
      />
      <div
        className={`w-full h-full min-h-svh flex-1 text-text-color flex flex-col bg-white dark:bg-dark-body transition-all duration-500 ease-in-out z-10 `}
      >
                      ...
                      >
                        ...
                        <div className="w-full flex items-end justify-between">
                          ...
                          <div className="flex items-center justify-start mt-3">
                            <div
                              title={userEmail}
                              className="h-7 w-auto aspect-square rounded-full flex items-center justify-center bg-violet-600 text-white text-base font-semibold ring-[3px] ring-white dark:ring-[#242424] uppercase"
                            >
                              {userEmail.charAt(0)}
                            </div>
                            {project.collaborations
                              ...
                              .map((collab, index) => (
                                <div
                                  key={index}
                                  title={collab}
                                  className="h-7 w-auto aspect-square rounded-full flex items-center justify-center bg-violet-600 text-white text-base font-semibold ml-[-5px] ring-[3px] ring-white dark:ring-[#242424] uppercase"
                                >
                                  {collab.charAt(0)}
                                </div>
                              ))}
                            {project.collaborations.length > 3 && (
                              <div className="h-7 w-auto aspect-square rounded-full flex items-center justify-center bg-violet-600 text-white text-sm font-medium ml-[-5px] ring-[3px] ring-white dark:ring-[#242424] uppercase">
                                +{project.collaborations.length - 3}
                              </div>
                            )}
                          </div>
