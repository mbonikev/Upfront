...
function Due() {
  ...
  return (
    <div className="w-full dark:bg-dark-body dark:text-light-text-color flex items-start justify-start relative">
      ...
      />
      <div
        className={`w-[calc(100%-256px)] h-full min-h-svh flex-1 text-text-color transition-all duration-500 ease-in-out z-10 flex items-start justify-start flex-col py-6`}
      >
              ...
              <div className="w-full h-full flex gap-2">
                ...
                <div className="flex flex-col w-full h-full text-text-color dark:text-light-text-color">
                  {[...Array(2)].map((_, index) => (
                    <button
                      key={index}
                      className="w-full h-fit flex-1 flex pr-3 group hover:bg-stone-100 dark:hover:bg-[#1f1f1f] p-2 border-b border-stone-200/60 dark:border-[#282828]"
                    >
                      <div className="w-full flex min-h-full gap-2 items-start justify-start">
                        <div className="w-full h-full text-sm font-medium flex items-center justify-between gap-5">
                          <div className="w-fit flex items-center justify-start gap-2.5">
                            <div className="text-xl text-[#5e5e5e] group-hover:text-green-600">
                              <LuCircleDashed />
                            </div>
                          ...
                          <div className="h-full text-xs flex items-center justify-end gap-2">
                            <div className="ring-1 ring-stone-200/60 dark:ring-[#282828] py-1 pl-1.5 pr-2.5 text-xs text-light-text-color/60 rounded-full flex items-center gap-1 ">
