        ...
        <div className="w-full flex items-start justify-start flex-col gap-2">
          ...
          <div className="w-full h-fit px-6">
            ...
            <div className="w-full flex items-start justify-start flex-col ring-1 ring-stone-200/60 dark:ring-[#282828] rounded-2xl p-1">
              <div className="w-full h-full min-h-[140px] flex gap-1">
                <div className="w-[140px] h-fit bg-stone-100 dark:bg-[#282828] text-text-color/95 rounded-xl p-2 flex">
                ...
                <div className="flex flex-wrap gap-1 w-full h-full text-text-color dark:text-light-text-color">
                  {[...Array(1)].map((_, index) => (
                    <div
                      key={index}
                      className="w-fit flex-1 max-w-[300px] flex pr-3 bg-stone-50 dark:bg-[#1f1f1f] rounded-xl p-2"
                    >
                      <div className="w-full flex min-h-full gap-2 items-start justify-start">
                        ...
                        <div className="w-full text-sm font-medium flex items-start justify-between gap-5 py-1">
                          ...
                          <div className="text-xs flex items-end justify-start flex-col gap-2">
                            <div className="w-fit flex items-center justify-end pt-12">
